...
4. Conclude with a final answer in a section labeled "Final Answer:". The final answer can only be 'Yes' or 'No'.
...
For each question in the batch, produce your answer in the following format:
Question: [the original test question]
Thoughts: [whatever thoughts or reasoning steps are needed to arrive at your conclusion]
Final Answer: Yes/No

Now, you will be provided with a batch of evaluation questions below.
{}
---

Ensure that each of the evaluation questions gets answered.
(TEMPLATE END)
"""
